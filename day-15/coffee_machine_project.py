...
def machine_can_make(item):
    ...
    if can_make:
        ...
        return False, f">> Sorry, there is not enough {item_out_of_stock}!"
...
def coffee_machine():
    ...
    while machine_loop:
        if order == 0:
            ...
            user_choice = input("\nWould you like anything else? Type (espresso/latte/cappuccino) "
                                "or Type 'no' to finish your order: ").lower()
